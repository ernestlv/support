...
public class  TemplateConfigServiceImpl implements TemplateConfigService {
    ...
    private static Log log = LogFactory.getLog(TemplateConfigServiceImpl.class);
...
//-------------------- Property Definitions
    ...
    @Property(label = "Header Path",
        ...
        value = "/content/food/regions/main-header/jcr:content/parsys/module")
    ...
    @Property(label = "Talents A-Z URL",
        description = "URL for Shows A-Z page",
        value = "/content/food/chefs/a-z.html")
    private static final String TALENTS_A_Z_URL = "talentsAtoZURL";
    
    @Property(label = "Cities A-Z URL",
        description = "URL for Cities A-Z page",
        value = "/content/food/restaurants/citiesA-Z.html")
    private static final String CITIES_A_Z_URL = "citiesAtoZURL";
    
    @Property(label = "Restaurants A-Z URL",
        description = "URL for Restaurants  A-Z page",
        value = "/content/food/restaurants/a-z.html")
    private static final String RESTAURANTS_A_Z_URL = "restaurantsAtoZURL";
    ...
    @Property(label = "Mobile Search Results URL",
            description = "URL for Mobile Search Results page",
            value = "/content/food/search/search-results.html")
        private static final String MOBILE_SEARCH_RESULTS_URL = "mobileSearchResultsURL";
    
    @Property(label = "Mobile Search Episode Modal URL",
            description = "URL for Mobile Search Episode Modal page",
            value = "/content/food/mobile-modal/mobile-search-episode.html")
        private static final String MOBILE_SEARCH_EPISODE_MODAL_URL = "mobileSearchEpisodeModalURL";
...
//-------------------- Members
    ...
    private volatile String talentsAtoZURL;
    private volatile String citiesAtoZURL;
    private volatile String restaurantsAtoZURL;
    private volatile String modalWindowPath;
    private volatile String mobileSearchResultsURL;
    private volatile String mobileSearchEpisodeModalURL;
...
//-------------------- Lifecycle behaviors
    ...
    private void mutatePropertiesFromContext(ComponentContext ctx){
        ...
        this.talentsAtoZURL = OsgiUtil.toString(props.get(TALENTS_A_Z_URL), null);
        this.citiesAtoZURL = OsgiUtil.toString(props.get(CITIES_A_Z_URL), null);
        this.restaurantsAtoZURL = OsgiUtil.toString(props.get(RESTAURANTS_A_Z_URL), null);
        this.modalWindowPath = OsgiUtil.toString(props.get(MODAL_WINDOW_PAGE_PATH),null);
        this.mobileSearchResultsURL = OsgiUtil.toString(props.get(MOBILE_SEARCH_RESULTS_URL), null);
        this.mobileSearchEpisodeModalURL = OsgiUtil.toString(props.get(MOBILE_SEARCH_EPISODE_MODAL_URL), null);
...
//-------------------- Getter/Setters
    ...
    public String getTalentsAtoZURL() {
        return talentsAtoZURL;
    }

    public void setTalentsAtoZURL(String talentsAtoZURL) {
        this.talentsAtoZURL = talentsAtoZURL;
    }

    public String getCitiesAtoZURL() {
        return citiesAtoZURL;
    }

    public void setCitiesAtoZURL(String citiesAtoZURL) {
        this.citiesAtoZURL = citiesAtoZURL;
    }

    public String getRestaurantsAtoZURL() {
        return restaurantsAtoZURL;
    }

    public void setRestaurantsAtoZURL(String restaurantsAtoZURL) {
        this.restaurantsAtoZURL = restaurantsAtoZURL;
    }
    ...
    public String getMobileSearchResultsURL() {
    	return mobileSearchResultsURL;
    }
    ...
    public void setMobileSearchResultsURL(String mobileSearchResultsURL) {
    	this.mobileSearchResultsURL = mobileSearchResultsURL;
    	
    }
    
    public String getMobileSearchEpisodeModalURL() {
		return mobileSearchEpisodeModalURL;
	}
    
    public void setMobileSearchEpisodeModalURL(String mobileSearchEpisodeModalURL) {
		this.mobileSearchEpisodeModalURL = mobileSearchEpisodeModalURL;
	}
}
